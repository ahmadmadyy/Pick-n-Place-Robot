...
int main(void)
{
  ...
  HAL_TIM_PWM_Start(&htim1, TIM_CHANNEL_4); //T1C4
  ...
  ServoMotor Servo4(htim1, TIM_CHANNEL_4); //PA11  Range: Closed: 70-75 to Open: 105-110
  ServoMotor Servo5(htim3, TIM_CHANNEL_1); //PB1
